...
@Client.on_message(filters.command(['thumbnail@MMLeech4bot', 'savethumbnail@MMLeech4bot', 'setthumbnail@MMLeech4bot']) & filters.chat(ALL_CHATS))
async def savethumbnail(client, message):
    ...
    if thumbset:
        ...
        await message.reply_text('🎞️ <b>Thumbnail Set</b>')
    else:
...
async def rmthumbnail(client, message):
    for path in ('thumbnail', 'watermarked_thumbnail'):
        ...
        if os.path.isfile(path):
            os.remove(path)
    await message.reply_text('🎞️ <b>Thumbnail cleared</b>')

help_dict['thumbnail'] = ('Thumbnail',
'''/thumbnail <i>&lt;as reply to image or as a caption&gt;</i>
/setthumbnail@MMLeech4bot <i>&lt;as reply to image or as a caption&gt;</i>
/savethumbnail@MMLeech4bot <i>&lt;as reply to image or as a caption&gt;</i>

/clearthumbnail@MMLeech4bot
/rmthumbnail
/removethumbnail
/delthumbnail
/deletethumbnail''')

...
@Client.on_message(filters.command(['thumbnail@MMLeechv5_bot', 'savethumbnail@MMLeechv5_bot', 'setthumbnail@MMLeechv5_bot']) & filters.chat(ALL_CHATS))
...
/setthumbnail@MMLeechv5_bot <i>&lt;as reply to image or as a caption&gt;</i>

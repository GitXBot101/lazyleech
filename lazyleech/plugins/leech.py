...
@Client.on_message(filters.command(['leechvideo', 'leechvideo1', 'zipdirectdl', 'zipdirect', 'leechfile@MMLeechv5_bot', 'leechfile1@MMLeechv5_bot']) & filters.chat(ALL_CHATS))
